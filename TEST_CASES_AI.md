...
| :--- | :--- | :--- | :--- |
| TC-02-HU-02 | [Inicio de sesión fallido con contraseña incorrecta](#tc-02-hu-02) | Dado que soy un empleado o administrador autorizado Y tengo una cuenta registrada en el sistema Cuando ingreso mi correo electrónico correcto pero una contraseña incorrecta Entonces el sistema muestra el mensaje "Correo o contraseña incorrectos" Y no me permite acceder al panel principal (dashboard) Y el mensaje no revela cuál de los dos campos es incorrecto | Se usó el texto exacto de la HU refinada y se aclaró que el mensaje no debe decir cuál campo falló, para evitar que alguien descubra qué correos existen. |
| TC-03-HU-02 | [Inicio de sesión fallido con correo electrónico no registrado](#tc-03-hu-02) | Dado que no tengo una cuenta registrada en el sistema Cuando ingreso un correo electrónico no registrado y una contraseña en el formulario de inicio de sesión Entonces el sistema muestra el mensaje "Correo o contraseña incorrectos" Y no me permite acceder al panel principal (dashboard) | El caso original mostraba si un correo existía o no, lo que le daría pistas a alguien malintencionado. Se cambió al mismo mensaje genérico de siempre. |
| TC-05-HU-02 | [Validación de longitud máxima permitida para el correo electrónico](#tc-05-hu-02) | Dado que estoy en la pantalla de inicio de sesión Cuando ingreso un correo electrónico que excede los 254 caracteres en el formulario Entonces el formulario no permite enviar la solicitud Y muestra una validación indicando que el formato del correo no es válido | El límite no estaba definido, así que no era reproducible. Se usó 254 caracteres como tope máximo y se ajustó el resultado para que la validación ocurra antes de enviar el formulario. |
| TC-07-HU-02 | [Redirección automática al inicio de sesión desde una sección protegida sin sesión activa](#tc-07-hu-02) | Dado que no he iniciado sesión en el sistema Cuando intento acceder directamente al panel principal (dashboard) escribiendo la URL en el navegador Entonces el sistema me redirige automáticamente a la pantalla de inicio de sesión Y no se muestra contenido del panel principal en ningún momento durante la redirección | Se quitó el mensaje de aviso que no estaba en la HU y se añadió que no debe mostrarse contenido protegido durante la redirección, que sí aparece en el contexto de negocio. |
| TC-09-HU-02 | [Indicador de carga al verificar sesión activa](#tc-09-hu-02) | Dado que accedo al sistema (a cualquier sección protegida) Y el sistema está verificando si existe una sesión activa Cuando la verificación está en proceso Entonces se muestra un indicador de carga Y no se muestra contenido restringido ni la pantalla parpadea durante la verificación Y una vez completada la verificación, se muestra la pantalla correspondiente (dashboard si hay sesión, login si no) | La precondición era incorrecta: el indicador aparece antes de cargar cualquier pantalla, no después de estar ya en el login. Se ajustó para reflejar ese momento. |
| TC-11-HU-02 | [Inicio de sesión con datos maliciosos](#tc-11-hu-02) | Dado que estoy en la pantalla de inicio de sesión Cuando ingreso en el campo de correo o contraseña valores con caracteres especiales, código o símbolos que no corresponden a datos normales de un formulario de login Entonces el sistema limpia los datos ingresados Y muestra el mensaje "Correo o contraseña incorrectos" Y no se ejecuta ningún código extraño ni se altera el comportamiento del formulario | "Datos maliciosos" era muy vago. Se aclaró qué tipo de valores ingresar y qué verificar como resultado. |
| TC-14-HU-02 | [Inicio de sesión exitoso con credenciales cifradas](#tc-14-hu-02) | Dado que soy un empleado o administrador autorizado Y tengo una cuenta registrada en el sistema Cuando ingreso mi correo electrónico y contraseña correctos y envío el formulario Entonces la dirección de la página muestra el candado de conexión segura Y las credenciales no aparecen visibles en la barra de dirección Y el inicio de sesión se completa exitosamente | El resultado original no era verificable a simple vista. Se reemplazó por algo que cualquier persona puede comprobar: el candado de seguridad en la barra de dirección. |
